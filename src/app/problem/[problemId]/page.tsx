  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const foundProblem = problemsData.problems.find((p: PlantProblem) => p._id === id);
        if (!foundProblem) {
